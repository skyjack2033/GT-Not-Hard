...
public class SingularityFluidRecipes {
    ...
    public static void addVoidFliudRecipes() {
        ...
        DeepDarkRecipes.put(601, Materials.LiquidNitrogen.getFluid(1000));
        DeepDarkRecipes.put(602, Materials.LiquidOxygen.getFluid(1000));
        DeepDarkRecipes.put(603, Materials.LPG.getFluid(1000));
        DeepDarkRecipes.put(604, Materials.Lubricant.getFluid(1000));

        DeepDarkRecipes.put(605, Materials.Lead.getPlasma(1000));

        // GregTech - M
        DeepDarkRecipes.put(606, Materials.Magnalium.getMolten(1000));
        DeepDarkRecipes.put(607, Materials.Magnesium.getMolten(1000));
        DeepDarkRecipes.put(608, Materials.Manganese.getMolten(1000));
        DeepDarkRecipes.put(609, Materials.Manyullyn.getMolten(1000));
        DeepDarkRecipes.put(610, Materials.MelodicAlloy.getMolten(1000));
        DeepDarkRecipes.put(611, Materials.MeteoricIron.getMolten(1000));
        DeepDarkRecipes.put(612, Materials.MeteoricSteel.getMolten(1000));
        DeepDarkRecipes.put(613, Materials.Mithril.getMolten(1000));
        DeepDarkRecipes.put(614, Materials.Molybdenum.getMolten(1000));
        DeepDarkRecipes.put(615, Materials.MysteriousCrystal.getMolten(1000));
        DeepDarkRecipes.put(616, Materials.Mytryl.getMolten(1000));

        DeepDarkRecipes.put(617, Materials.Magnesiumchloride.getFluid(1000));
        DeepDarkRecipes.put(618, Materials.McGuffium239.getFluid(1000));
        DeepDarkRecipes.put(619, Materials.Mercury.getFluid(1000));
        DeepDarkRecipes.put(620, Materials.Methanol.getFluid(1000));
        DeepDarkRecipes.put(621, Materials.MethylAcetate.getFluid(1000));
        DeepDarkRecipes.put(622, Materials.Milk.getFluid(1000));

        DeepDarkRecipes.put(623, Materials.Methane.getGas(1000));
        DeepDarkRecipes.put(624, Materials.MTBEMixture.getGas(1000));

        // GregTech - N
        DeepDarkRecipes.put(625, Materials.Naquadah.getMolten(1000));
        DeepDarkRecipes.put(626, Materials.NaquadahAlloy.getMolten(1000));
        DeepDarkRecipes.put(627, Materials.NaquadahEnriched.getMolten(1000));
        DeepDarkRecipes.put(628, Materials.Naquadria.getMolten(1000));
        DeepDarkRecipes.put(629, Materials.Neodymium.getMolten(1000));
        DeepDarkRecipes.put(630, Materials.NeodymiumMagnetic.getMolten(1000));
        DeepDarkRecipes.put(631, Materials.Neutronium.getMolten(1000));
        DeepDarkRecipes.put(632, Materials.Nichrome.getMolten(1000));
        DeepDarkRecipes.put(633, Materials.Nickel.getMolten(1000));
        DeepDarkRecipes.put(634, Materials.NickelZincFerrite.getMolten(1000));
        DeepDarkRecipes.put(635, Materials.Niobium.getMolten(1000));
        DeepDarkRecipes.put(636, Materials.NiobiumNitride.getMolten(1000));
        DeepDarkRecipes.put(637, Materials.NiobiumTitanium.getMolten(1000));

        DeepDarkRecipes.put(638, Materials.Naphtha.getFluid(1000));
        DeepDarkRecipes.put(639, Materials.NitrationMixture.getFluid(1000));
        DeepDarkRecipes.put(640, Materials.NitricAcid.getFluid(1000));
        DeepDarkRecipes.put(641, Materials.Nitrochlorobenzene.getFluid(1000));
        DeepDarkRecipes.put(642, Materials.NitroFuel.getFluid(1000));

        DeepDarkRecipes.put(643, Materials.NatruralGas.getGas(1000));
        DeepDarkRecipes.put(644, Materials.NitricOxide.getGas(1000));
        DeepDarkRecipes.put(645, Materials.Nitrogen.getGas(1000));
        DeepDarkRecipes.put(646, Materials.NitrogenDioxide.getGas(1000));
        DeepDarkRecipes.put(647, Materials.NitrousOxide.getGas(1000));
        DeepDarkRecipes.put(648, Materials.NobleGases.getGas(1000));

        DeepDarkRecipes.put(649, Materials.Naquadria.getPlasma(1000));
        DeepDarkRecipes.put(650, Materials.Nickel.getPlasma(1000));
        DeepDarkRecipes.put(651, Materials.Niobium.getPlasma(1000));
        DeepDarkRecipes.put(652, Materials.Nitrogen.getPlasma(1000));

        // GregTech - O
        DeepDarkRecipes.put(653, Materials.Obsidian.getMolten(1000));
        DeepDarkRecipes.put(654, Materials.Orichalcum.getMolten(1000));
        DeepDarkRecipes.put(655, Materials.Oriharukon.getMolten(1000));
        DeepDarkRecipes.put(656, Materials.Osmiridium.getMolten(1000));
        DeepDarkRecipes.put(657, Materials.Osmium.getMolten(1000));

        DeepDarkRecipes.put(658, Materials.Octane.getFluid(1000));
        DeepDarkRecipes.put(659, Materials.Oil.getFluid(1000));
        DeepDarkRecipes.put(660, Materials.OilExtraHeavy.getFluid(1000));
        DeepDarkRecipes.put(661, Materials.OilHeavy.getFluid(1000));
        DeepDarkRecipes.put(662, Materials.OilLight.getFluid(1000));
        DeepDarkRecipes.put(663, Materials.OilMedium.getFluid(1000));

        DeepDarkRecipes.put(664, Materials.Oxygen.getGas(1000));
        DeepDarkRecipes.put(665, Materials.Ozone.getGas(1000));

        DeepDarkRecipes.put(666, Materials.Oxygen.getPlasma(1000));

        // GregTech - P
        DeepDarkRecipes.put(667, Materials.Palladium.getMolten(1000));
        DeepDarkRecipes.put(668, Materials.Pentacadmiummagnesiumhexaoxid.getMolten(1000));
        DeepDarkRecipes.put(669, Materials.PigIron.getMolten(1000));
        DeepDarkRecipes.put(670, Materials.Plastic.getMolten(1000));
        DeepDarkRecipes.put(671, Materials.Platinum.getMolten(1000));
        DeepDarkRecipes.put(672, Materials.Plutonium.getMolten(1000));
        DeepDarkRecipes.put(673, Materials.Plutonium241.getMolten(1000));
        DeepDarkRecipes.put(674, Materials.Polybenzimidazole.getMolten(1000));
        DeepDarkRecipes.put(675, Materials.Polycaprolactam.getMolten(1000));
        DeepDarkRecipes.put(676, Materials.PolyphenyleneSulfide.getMolten(1000));
        DeepDarkRecipes.put(677, Materials.Polystyrene.getMolten(1000));
        DeepDarkRecipes.put(678, Materials.Polytetrafluoroethylene.getMolten(1000));
        DeepDarkRecipes.put(679, Materials.PolyvinylChloride.getMolten(1000));
        DeepDarkRecipes.put(680, Materials.Potassium.getMolten(1000));
        DeepDarkRecipes.put(681, Materials.Praseodymium.getMolten(1000));
        DeepDarkRecipes.put(682, Materials.Promethium.getMolten(1000));
        DeepDarkRecipes.put(683, Materials.PulsatingIron.getMolten(1000));

        DeepDarkRecipes.put(684, Materials.Phenol.getFluid(1000));
        DeepDarkRecipes.put(685, Materials.PhosphoricAcid.getFluid(1000));
        DeepDarkRecipes.put(686, Materials.PhthalicAcid.getFluid(1000));
        DeepDarkRecipes.put(687, Materials.PolyAluminiumChloride.getFluid(1000));
        DeepDarkRecipes.put(688, Materials.PolyvinylAcetate.getFluid(1000));

        DeepDarkRecipes.put(689, Materials.Propane.getGas(1000));
        DeepDarkRecipes.put(690, Materials.Propene.getGas(1000));

        DeepDarkRecipes.put(691, Materials.Plutonium241.getPlasma(1000));

        // GregTech - Q
        DeepDarkRecipes.put(692, Materials.Quantium.getMolten(1000));

        // GregTech - R
        DeepDarkRecipes.put(693, Materials.RadoxPolymer.getMolten(1000));
        DeepDarkRecipes.put(694, Materials.Realgar.getMolten(1000));
        DeepDarkRecipes.put(695, Materials.RedAlloy.getMolten(1000));
        DeepDarkRecipes.put(696, Materials.RedSteel.getMolten(1000));
        DeepDarkRecipes.put(697, Materials.Redstone.getMolten(1000));
        DeepDarkRecipes.put(698, Materials.Reinforced.getMolten(1000));
        DeepDarkRecipes.put(699, Materials.ReinforceGlass.getMolten(1000));
        DeepDarkRecipes.put(700, Materials.RoseGold.getMolten(1000));
        DeepDarkRecipes.put(701, Materials.Rubber.getMolten(1000));
        DeepDarkRecipes.put(702, Materials.Rubidium.getMolten(1000));
        DeepDarkRecipes.put(703, Materials.Rubracium.getMolten(1000));

        DeepDarkRecipes.put(704, Materials.RedMud.getFluid(1000));

        DeepDarkRecipes.put(705, Materials.Radon.getGas(1000));
        DeepDarkRecipes.put(706, Materials.RadoxPolymer.getGas(1000));

        DeepDarkRecipes.put(707, Materials.Radon.getPlasma(1000));

        // GregTech - S
        DeepDarkRecipes.put(708, Materials.Samarium.getMolten(1000));
        DeepDarkRecipes.put(709, Materials.SamariumMagnetic.getMolten(1000));
        DeepDarkRecipes.put(710, Materials.Scandium.getMolten(1000));
        DeepDarkRecipes.put(711, Materials.Shadow.getMolten(1000));
        DeepDarkRecipes.put(712, Materials.ShadowIron.getMolten(1000));
        DeepDarkRecipes.put(713, Materials.ShadowSteel.getMolten(1000));
        DeepDarkRecipes.put(714, Materials.Silicon.getMolten(1000));
        DeepDarkRecipes.put(715, Materials.Silicone.getMolten(1000));
        DeepDarkRecipes.put(716, Materials.SiliconSG.getMolten(1000));
        DeepDarkRecipes.put(717, Materials.Silver.getMolten(1000));
        DeepDarkRecipes.put(718, Materials.SolderingAlloy.getMolten(1000));
        DeepDarkRecipes.put(719, Materials.Soularium.getMolten(1000));
        DeepDarkRecipes.put(720, Materials.StainlessSteel.getMolten(1000));
        DeepDarkRecipes.put(721, Materials.Steel.getMolten(1000));
        DeepDarkRecipes.put(722, Materials.SteelMagnetic.getMolten(1000));
        DeepDarkRecipes.put(723, Materials.StellarAlloy.getMolten(1000));
        DeepDarkRecipes.put(724, Materials.SterlingSilver.getMolten(1000));
        DeepDarkRecipes.put(725, Materials.Strontium.getMolten(1000));
        DeepDarkRecipes.put(726, Materials.StyreneButadieneRubber.getMolten(1000));
        DeepDarkRecipes.put(727, Materials.Sugar.getMolten(1000));
        DeepDarkRecipes.put(728, Materials.Sunnarium.getMolten(1000));
        DeepDarkRecipes.put(729, Materials.SuperconductorUEVBase.getMolten(1000));
        DeepDarkRecipes.put(730, Materials.SuperconductorUIVBase.getMolten(1000));
        DeepDarkRecipes.put(731, Materials.SuperconductorUMVBase.getMolten(1000));

        DeepDarkRecipes.put(732, Materials.SaltWater.getFluid(1000));
        DeepDarkRecipes.put(733, Materials.SeedOil.getFluid(1000));
        DeepDarkRecipes.put(734, Materials.SiliconTetrachloride.getFluid(1000));
        DeepDarkRecipes.put(735, Materials.Sodium.getFluid(1000));
        DeepDarkRecipes.put(736, Materials.SodiumPersulfate.getFluid(1000));
        DeepDarkRecipes.put(737, Materials.StableBaryonicMatter.getFluid(1000));
        DeepDarkRecipes.put(738, Materials.Styrene.getFluid(1000));
        DeepDarkRecipes.put(739, Materials.SulfuricAcid.getFluid(1000));
        DeepDarkRecipes.put(740, Materials.SulfuricHeavyFuel.getFluid(1000));
        DeepDarkRecipes.put(741, Materials.SulfuricLightFuel.getFluid(1000));
        DeepDarkRecipes.put(742, Materials.SulfuricNaphtha.getFluid(1000));
        DeepDarkRecipes.put(743, Materials.SuperCoolant.getFluid(1000));

        DeepDarkRecipes.put(744, Materials.Silane.getGas(1000));
        DeepDarkRecipes.put(745, Materials.SiliconTetrafluoride.getGas(1000));
        DeepDarkRecipes.put(746, Materials.SulfurDioxide.getGas(1000));
        DeepDarkRecipes.put(747, Materials.SulfuricGas.getGas(1000));
        DeepDarkRecipes.put(748, Materials.SulfurTrioxide.getGas(1000));

        DeepDarkRecipes.put(749, Materials.Silver.getPlasma(1000));
        DeepDarkRecipes.put(750, Materials.Sulfur.getPlasma(1000));

        // GregTech - T
        DeepDarkRecipes.put(751, Materials.Tantalum.getMolten(1000));
        DeepDarkRecipes.put(752, Materials.Tartarite.getMolten(1000));
        DeepDarkRecipes.put(753, Materials.Tellurium.getMolten(1000));
        DeepDarkRecipes.put(754, Materials.TengamAttuned.getMolten(1000));
        DeepDarkRecipes.put(755, Materials.TengamPurified.getMolten(1000));
        DeepDarkRecipes.put(756, Materials.Terbium.getMolten(1000));
        DeepDarkRecipes.put(757, Materials.Tetraindiumditindibariumtitaniumheptacoppertetrakaidekaoxid.getMolten(1000));
        DeepDarkRecipes.put(758, Materials.Tetranaquadahdiindiumhexaplatiumosminid.getMolten(1000));
        DeepDarkRecipes.put(759, Materials.Thaumium.getMolten(1000));
        DeepDarkRecipes.put(760, Materials.Thorium.getMolten(1000));
        DeepDarkRecipes.put(761, Materials.Thulium.getMolten(1000));
        DeepDarkRecipes.put(762, Materials.Tin.getMolten(1000));
        DeepDarkRecipes.put(763, Materials.TinAlloy.getMolten(1000));
        DeepDarkRecipes.put(764, Materials.Titanium.getPlasma(1000));
        DeepDarkRecipes.put(765, Materials.Titanium.getMolten(1000));
        DeepDarkRecipes.put(766, Materials.Titaniumonabariumdecacoppereikosaoxid.getMolten(1000));
        DeepDarkRecipes.put(767, Materials.TPV.getMolten(1000));
        DeepDarkRecipes.put(768, Materials.Trinium.getMolten(1000));
        DeepDarkRecipes.put(769, Materials.Tritanium.getMolten(1000));
        DeepDarkRecipes.put(770, Materials.Tungsten.getMolten(1000));
        DeepDarkRecipes.put(771, Materials.TungstenCarbide.getMolten(1000));
        DeepDarkRecipes.put(772, Materials.TungstenSteel.getMolten(1000));

        DeepDarkRecipes.put(773, Materials.Tetranitromethane.getFluid(1000));
        DeepDarkRecipes.put(774, Materials.Titaniumtetrachloride.getFluid(1000));
        DeepDarkRecipes.put(775, Materials.Toluene.getFluid(1000));
        DeepDarkRecipes.put(776, Materials.Trichlorosilane.getFluid(1000));

        DeepDarkRecipes.put(777, Materials.Tetrafluoroethylene.getGas(1000));
        DeepDarkRecipes.put(778, Materials.Tritium.getGas(1000));

        DeepDarkRecipes.put(779, Materials.Thorium.getPlasma(1000));
        DeepDarkRecipes.put(780, Materials.Tin.getPlasma(1000));

        // GregTech - U
        DeepDarkRecipes.put(781, Materials.Ultimet.getMolten(1000));
        DeepDarkRecipes.put(782, Materials.Uranium.getMolten(1000));
        DeepDarkRecipes.put(783, Materials.Uranium235.getMolten(1000));
        DeepDarkRecipes.put(784, Materials.Uraniumtriplatinid.getMolten(1000));

        DeepDarkRecipes.put(785, Materials.UUAmplifier.getFluid(1000));

        // GregTech - V
        DeepDarkRecipes.put(786, Materials.Vanadium.getMolten(1000));
        DeepDarkRecipes.put(787, Materials.VanadiumGallium.getMolten(1000));
        DeepDarkRecipes.put(788, Materials.VanadiumSteel.getMolten(1000));
        DeepDarkRecipes.put(789, Materials.Vanadiumtriindinid.getMolten(1000));
        DeepDarkRecipes.put(790, Materials.VibrantAlloy.getMolten(1000));
        DeepDarkRecipes.put(791, Materials.Vinteum.getMolten(1000));
        DeepDarkRecipes.put(792, Materials.VividAlloy.getMolten(1000));
        DeepDarkRecipes.put(793, Materials.Void.getMolten(1000));
        DeepDarkRecipes.put(794, Materials.Vulcanite.getMolten(1000));
        DeepDarkRecipes.put(795, Materials.Vyroxeres.getMolten(1000));

        DeepDarkRecipes.put(796, Materials.VinylAcetate.getFluid(1000));

        DeepDarkRecipes.put(797, Materials.VinylChloride.getGas(1000));

        // GregTech - W
        DeepDarkRecipes.put(798, Materials.WroughtIron.getMolten(1000));

        DeepDarkRecipes.put(799, Materials.WoodTar.getFluid(1000));
        DeepDarkRecipes.put(800, Materials.WoodVinegar.getFluid(1000));

        DeepDarkRecipes.put(801, Materials.WoodGas.getGas(1000));

        // GregTech - X

        // GregTech - Y
        DeepDarkRecipes.put(802, Materials.Ytterbium.getMolten(1000));
        DeepDarkRecipes.put(803, Materials.Yttrium.getMolten(1000));
        DeepDarkRecipes.put(804, Materials.YttriumBariumCuprate.getMolten(1000));

        // GregTech - Z
        DeepDarkRecipes.put(805, Materials.Zinc.getMolten(1000));

        DeepDarkRecipes.put(806, Materials.Zinc.getPlasma(1000));

        // GregTechPlusPlus
        DeepDarkRecipes.put(807, FluidRegistry.getFluidStack("neon", 1000));
        DeepDarkRecipes.put(808, FluidRegistry.getFluidStack("plasma.neon", 1000));
        DeepDarkRecipes.put(809, FluidRegistry.getFluidStack("molten.germanium", 1000));
        DeepDarkRecipes.put(810, FluidRegistry.getFluidStack("plasma.germanium", 1000));
        DeepDarkRecipes.put(811, FluidRegistry.getFluidStack("molten.selenium", 1000));
        DeepDarkRecipes.put(812, FluidRegistry.getFluidStack("plasma.selenium", 1000));
        DeepDarkRecipes.put(813, FluidRegistry.getFluidStack("molten.bromine", 1000));
        DeepDarkRecipes.put(814, FluidRegistry.getFluidStack("plasma.bromine", 1000));
        DeepDarkRecipes.put(815, FluidRegistry.getFluidStack("krypton", 1000));
        DeepDarkRecipes.put(816, FluidRegistry.getFluidStack("plasma.krypton", 1000));
        DeepDarkRecipes.put(817, FluidRegistry.getFluidStack("molten.zirconium", 1000));
        DeepDarkRecipes.put(818, FluidRegistry.getFluidStack("plasma.zirconium", 1000));
        DeepDarkRecipes.put(819, FluidRegistry.getFluidStack("molten.ruthenium", 1000));
        DeepDarkRecipes.put(820, FluidRegistry.getFluidStack("plasma.ruthenium", 1000));
        DeepDarkRecipes.put(821, FluidRegistry.getFluidStack("molten.rhodium", 1000));
        DeepDarkRecipes.put(822, FluidRegistry.getFluidStack("plasma.rhodium", 1000));
        DeepDarkRecipes.put(823, FluidRegistry.getFluidStack("molten.technetium", 1000));
        DeepDarkRecipes.put(824, FluidRegistry.getFluidStack("plasma.technetium", 1000));
        DeepDarkRecipes.put(825, FluidRegistry.getFluidStack("molten.neptunium", 1000));
        DeepDarkRecipes.put(826, FluidRegistry.getFluidStack("plasma.neptunium", 1000));
        DeepDarkRecipes.put(827, FluidRegistry.getFluidStack("molten.iodine", 1000));
        DeepDarkRecipes.put(828, FluidRegistry.getFluidStack("plasma.iodine", 1000));
        DeepDarkRecipes.put(829, FluidRegistry.getFluidStack("xenon", 1000));
        DeepDarkRecipes.put(830, FluidRegistry.getFluidStack("plasma.xenon", 1000));
        DeepDarkRecipes.put(831, FluidRegistry.getFluidStack("molten.hafnium", 1000));
        DeepDarkRecipes.put(832, FluidRegistry.getFluidStack("plasma.hafnium", 1000));
        DeepDarkRecipes.put(833, FluidRegistry.getFluidStack("molten.rhenium", 1000));
        DeepDarkRecipes.put(834, FluidRegistry.getFluidStack("plasma.rhenium", 1000));
        DeepDarkRecipes.put(835, FluidRegistry.getFluidStack("molten.thallium", 1000));
        DeepDarkRecipes.put(836, FluidRegistry.getFluidStack("plasma.thallium", 1000));
        DeepDarkRecipes.put(837, FluidRegistry.getFluidStack("molten.polonium", 1000));
        DeepDarkRecipes.put(838, FluidRegistry.getFluidStack("plasma.polonium", 1000));

        DeepDarkRecipes.put(839, FluidRegistry.getFluidStack("molten.radium", 1000));
        DeepDarkRecipes.put(840, FluidRegistry.getFluidStack("plasma.radium", 1000));
        DeepDarkRecipes.put(841, FluidRegistry.getFluidStack("molten.protactinium", 1000));
        DeepDarkRecipes.put(842, FluidRegistry.getFluidStack("plasma.protactinium", 1000));
        DeepDarkRecipes.put(843, FluidRegistry.getFluidStack("molten.curium", 1000));
        DeepDarkRecipes.put(844, FluidRegistry.getFluidStack("plasma.curium", 1000));
        DeepDarkRecipes.put(845, FluidRegistry.getFluidStack("molten.californium", 1000));
        DeepDarkRecipes.put(846, FluidRegistry.getFluidStack("plasma.californium", 1000));
        DeepDarkRecipes.put(847, FluidRegistry.getFluidStack("molten.fermium", 1000));
        DeepDarkRecipes.put(848, FluidRegistry.getFluidStack("plasma.fermium", 1000));
        DeepDarkRecipes.put(849, FluidRegistry.getFluidStack("molten.uranium232", 1000));
        DeepDarkRecipes.put(850, FluidRegistry.getFluidStack("plasma.uranium232", 1000));
        DeepDarkRecipes.put(851, FluidRegistry.getFluidStack("molten.uranium233", 1000));
        DeepDarkRecipes.put(852, FluidRegistry.getFluidStack("plasma.uranium233", 1000));
        DeepDarkRecipes.put(853, FluidRegistry.getFluidStack("molten.thorium232", 1000));
        DeepDarkRecipes.put(854, FluidRegistry.getFluidStack("plasma.thorium232", 1000));
        DeepDarkRecipes.put(855, FluidRegistry.getFluidStack("molten.plutonium238", 1000));
        DeepDarkRecipes.put(856, FluidRegistry.getFluidStack("plasma.plutonium238", 1000));
        DeepDarkRecipes.put(857, FluidRegistry.getFluidStack("molten.celestialtungsten", 1000));
        DeepDarkRecipes.put(858, FluidRegistry.getFluidStack("plasma.celestialtungsten", 1000));
        DeepDarkRecipes.put(859, FluidRegistry.getFluidStack("molten.astraltitanium", 1000));
        DeepDarkRecipes.put(860, FluidRegistry.getFluidStack("plasma.astraltitanium", 1000));
        DeepDarkRecipes.put(861, FluidRegistry.getFluidStack("molten.chromaticglass", 1000));
        DeepDarkRecipes.put(862, FluidRegistry.getFluidStack("plasma.chromaticglass", 1000));
        DeepDarkRecipes.put(863, FluidRegistry.getFluidStack("molten.energycrystal", 1000));
        DeepDarkRecipes.put(864, FluidRegistry.getFluidStack("molten.bloodsteel", 1000));
        DeepDarkRecipes.put(865, FluidRegistry.getFluidStack("molten.staballoy", 1000));
        DeepDarkRecipes.put(866, FluidRegistry.getFluidStack("molten.tantalloy60", 1000));
        DeepDarkRecipes.put(867, FluidRegistry.getFluidStack("molten.tantalloy61", 1000));
        DeepDarkRecipes.put(868, FluidRegistry.getFluidStack("molten.tumbaga", 1000));
        DeepDarkRecipes.put(869, FluidRegistry.getFluidStack("molten.potin", 1000));
        DeepDarkRecipes.put(870, FluidRegistry.getFluidStack("molten.inconel625", 1000));
        DeepDarkRecipes.put(871, FluidRegistry.getFluidStack("molten.inconel690", 1000));
        DeepDarkRecipes.put(872, FluidRegistry.getFluidStack("molten.inconel792", 1000));
        DeepDarkRecipes.put(873, FluidRegistry.getFluidStack("molten.nitinol60", 1000));
        DeepDarkRecipes.put(874, FluidRegistry.getFluidStack("molten.zeron100", 1000));
        DeepDarkRecipes.put(875, FluidRegistry.getFluidStack("molten.maragingsteel250", 1000));
        DeepDarkRecipes.put(876, FluidRegistry.getFluidStack("molten.maragingsteel300", 1000));
        DeepDarkRecipes.put(877, FluidRegistry.getFluidStack("molten.maragingsteel350", 1000));
        DeepDarkRecipes.put(878, FluidRegistry.getFluidStack("molten.watertightsteel", 1000));
        DeepDarkRecipes.put(879, FluidRegistry.getFluidStack("molten.stellite", 1000));
        DeepDarkRecipes.put(880, FluidRegistry.getFluidStack("molten.talonite", 1000));
        DeepDarkRecipes.put(881, FluidRegistry.getFluidStack("molten.hastelloyw", 1000));
        DeepDarkRecipes.put(882, FluidRegistry.getFluidStack("molten.hastelloyx", 1000));
        DeepDarkRecipes.put(883, FluidRegistry.getFluidStack("molten.hastelloyn", 1000));
        DeepDarkRecipes.put(884, FluidRegistry.getFluidStack("molten.hastelloyc276", 1000));
        DeepDarkRecipes.put(885, FluidRegistry.getFluidStack("molten.incoloy020", 1000));

        DeepDarkRecipes.put(886, FluidRegistry.getFluidStack("molten.incoloyds", 1000));
        DeepDarkRecipes.put(887, FluidRegistry.getFluidStack("molten.incoloyma956", 1000));
        DeepDarkRecipes.put(888, FluidRegistry.getFluidStack("molten.tungstentitaniumcarbide", 1000));
        DeepDarkRecipes.put(889, FluidRegistry.getFluidStack("molten.siliconcarbide", 1000));
        DeepDarkRecipes.put(890, FluidRegistry.getFluidStack("molten.tantalumcarbide", 1000));
        DeepDarkRecipes.put(891, FluidRegistry.getFluidStack("molten.zirconiumcarbide", 1000));
        DeepDarkRecipes.put(892, FluidRegistry.getFluidStack("molten.niobiumcarbide", 1000));
        DeepDarkRecipes.put(893, FluidRegistry.getFluidStack("molten.arcanite", 1000));
        DeepDarkRecipes.put(894, FluidRegistry.getFluidStack("molten.grisium", 1000));
        DeepDarkRecipes.put(895, FluidRegistry.getFluidStack("molten.eglinsteelbasecompound", 1000));
        DeepDarkRecipes.put(896, FluidRegistry.getFluidStack("molten.eglinsteel", 1000));
        DeepDarkRecipes.put(897, FluidRegistry.getFluidStack("molten.hg1223", 1000));
        DeepDarkRecipes.put(898, FluidRegistry.getFluidStack("molten.hs188a", 1000));
        DeepDarkRecipes.put(899, FluidRegistry.getFluidStack("molten.triniumtitaniumalloy", 1000));
        DeepDarkRecipes.put(900, FluidRegistry.getFluidStack("molten.triniumnaquadahalloy", 1000));
        DeepDarkRecipes.put(901, FluidRegistry.getFluidStack("molten.triniumnaquadahcarbonite", 1000));
        DeepDarkRecipes.put(902, FluidRegistry.getFluidStack("molten.arceusalloy2b", 1000));
        DeepDarkRecipes.put(903, FluidRegistry.getFluidStack("molten.koboldite", 1000));
        DeepDarkRecipes.put(904, FluidRegistry.getFluidStack("molten.helicopter", 1000));
        DeepDarkRecipes.put(905, FluidRegistry.getFluidStack("molten.lafiumcompound", 1000));
        DeepDarkRecipes.put(906, FluidRegistry.getFluidStack("molten.cinobitea243", 1000));
        DeepDarkRecipes.put(907, FluidRegistry.getFluidStack("molten.pikyonium64b", 1000));
        DeepDarkRecipes.put(908, FluidRegistry.getFluidStack("molten.abyssalalloy", 1000));
        DeepDarkRecipes.put(909, FluidRegistry.getFluidStack("molten.laurenium", 1000));
        DeepDarkRecipes.put(910, FluidRegistry.getFluidStack("molten.botmium", 1000));
        DeepDarkRecipes.put(911, FluidRegistry.getFluidStack("molten.titansteel", 1000));
        DeepDarkRecipes.put(912, FluidRegistry.getFluidStack("molten.octiron", 1000));
        DeepDarkRecipes.put(913, FluidRegistry.getFluidStack("molten.blacktitanium", 1000));
        DeepDarkRecipes.put(914, FluidRegistry.getFluidStack("molten.babbitalloy", 1000));
        DeepDarkRecipes.put(915, FluidRegistry.getFluidStack("molten.indalloy140", 1000));
        DeepDarkRecipes.put(916, FluidRegistry.getFluidStack("molten.quantum", 1000));
        DeepDarkRecipes.put(917, FluidRegistry.getFluidStack("molten.advancednitinol", 1000));
        DeepDarkRecipes.put(918, FluidRegistry.getFluidStack("plasma.advancednitinol", 1000));
        DeepDarkRecipes.put(919, FluidRegistry.getFluidStack("molten.hypogen", 1000));
        DeepDarkRecipes.put(920, FluidRegistry.getFluidStack("plasma.hypogen", 1000));
        DeepDarkRecipes.put(921, FluidRegistry.getFluidStack("molten.rhugnor", 1000));
        DeepDarkRecipes.put(922, FluidRegistry.getFluidStack("plasma.rhugnor", 1000));
        DeepDarkRecipes.put(923, FluidRegistry.getFluidStack("molten.force", 1000));
        DeepDarkRecipes.put(924, FluidRegistry.getFluidStack("plasma.force", 1000));
        DeepDarkRecipes.put(925, FluidRegistry.getFluidStack("molten.blackmetal", 1000));
        DeepDarkRecipes.put(926, FluidRegistry.getFluidStack("molten.whitemetal", 1000));
        DeepDarkRecipes.put(927, FluidRegistry.getFluidStack("molten.runite", 1000));
        DeepDarkRecipes.put(928, FluidRegistry.getFluidStack("plasma.runite", 1000));
        DeepDarkRecipes.put(929, FluidRegistry.getFluidStack("molten.dragonblood", 1000));
        DeepDarkRecipes.put(930, FluidRegistry.getFluidStack("plasma.dragonblood", 1000));
        DeepDarkRecipes.put(931, FluidRegistry.getFluidStack("molten.solarsaltcold", 1000));
        DeepDarkRecipes.put(932, FluidRegistry.getFluidStack("molten.solarsalthot", 1000));
        DeepDarkRecipes.put(933, FluidRegistry.getFluidStack("molten.seleniumdioxide", 1000));

        DeepDarkRecipes.put(934, FluidRegistry.getFluidStack("molten.seleniousacid", 1000));
        DeepDarkRecipes.put(935, FluidRegistry.getFluidStack("hydrogencyanide", 1000));
        DeepDarkRecipes.put(936, FluidRegistry.getFluidStack("molten.hydroxide", 1000));
        DeepDarkRecipes.put(937, FluidRegistry.getFluidStack("molten.ammonium", 1000));
        DeepDarkRecipes.put(938, FluidRegistry.getFluidStack("molten.hydrogenchloridemix", 1000));
        DeepDarkRecipes.put(939, FluidRegistry.getFluidStack("molten.aceticanhydride", 1000));
        DeepDarkRecipes.put(940, FluidRegistry.getFluidStack("molten.chloroaceticacid", 1000));
        DeepDarkRecipes.put(941, FluidRegistry.getFluidStack("molten.dichloroaceticacid", 1000));
        DeepDarkRecipes.put(942, FluidRegistry.getFluidStack("molten.trichloroaceticacid", 1000));
        DeepDarkRecipes.put(943, FluidRegistry.getFluidStack("molten.chloroaceticmixture", 1000));
        DeepDarkRecipes.put(944, FluidRegistry.getFluidStack("molten.solidacidcatalystmixture", 1000));
        DeepDarkRecipes.put(945, FluidRegistry.getFluidStack("molten.ethylcyanoacetate", 1000));
        DeepDarkRecipes.put(946, FluidRegistry.getFluidStack("molten.cyanoacrylatepolymer", 1000));
        DeepDarkRecipes.put(947, FluidRegistry.getFluidStack("molten.ethylcyanoacrylatesuperglue", 1000));
        DeepDarkRecipes.put(948, FluidRegistry.getFluidStack("molten.mutatedlivingsolder", 1000));
        DeepDarkRecipes.put(949, FluidRegistry.getFluidStack("molten.thoriumtetrafluoride", 1000));
        DeepDarkRecipes.put(950, FluidRegistry.getFluidStack("molten.thoriumhexafluoride", 1000));
        DeepDarkRecipes.put(951, FluidRegistry.getFluidStack("molten.uraniumtetrafluoride", 1000));
        DeepDarkRecipes.put(952, FluidRegistry.getFluidStack("molten.uraniumhexafluoride", 1000));
        DeepDarkRecipes.put(953, FluidRegistry.getFluidStack("molten.berylliumfluoride", 1000));
        DeepDarkRecipes.put(954, FluidRegistry.getFluidStack("molten.lithiumfluoride", 1000));
        DeepDarkRecipes.put(955, FluidRegistry.getFluidStack("molten.ammoniumbifluoride", 1000));
        DeepDarkRecipes.put(956, FluidRegistry.getFluidStack("molten.berylliumhydroxide", 1000));
        DeepDarkRecipes.put(957, FluidRegistry.getFluidStack("molten.ammoniumtetrafluoroberyllate", 1000));
        DeepDarkRecipes.put(958, FluidRegistry.getFluidStack("neptuniumhexafluoride", 1000));
        DeepDarkRecipes.put(959, FluidRegistry.getFluidStack("technetiumhexafluoride", 1000));
        DeepDarkRecipes.put(960, FluidRegistry.getFluidStack("seleniumhexafluoride", 1000));
        DeepDarkRecipes.put(961, FluidRegistry.getFluidStack("molten.sodiumfluoride", 1000));
        DeepDarkRecipes.put(962, FluidRegistry.getFluidStack("molten.lithiumtetrafluoroberyllatelftb", 1000));
        DeepDarkRecipes.put(963, FluidRegistry.getFluidStack("molten.lftrfuel3", 1000));
        DeepDarkRecipes.put(964, FluidRegistry.getFluidStack("molten.lftrfuel2", 1000));
        DeepDarkRecipes.put(965, FluidRegistry.getFluidStack("molten.lftrfuel1", 1000));
        DeepDarkRecipes.put(966, FluidRegistry.getFluidStack("molten.burntreactorfueli", 1000));
        DeepDarkRecipes.put(967, FluidRegistry.getFluidStack("molten.burntreactorfuelii", 1000));
        DeepDarkRecipes.put(968, FluidRegistry.getFluidStack("molten.uraniumdepletedmoltensaltusalt", 1000));
        DeepDarkRecipes.put(969, FluidRegistry.getFluidStack("molten.heliumspargedusalt", 1000));
        DeepDarkRecipes.put(970, FluidRegistry.getFluidStack("molten.phosphorousuraniumhexafluoridepuf6", 1000));
        DeepDarkRecipes.put(971, FluidRegistry.getFluidStack("molten.stablemoltensaltbase", 1000));
        DeepDarkRecipes.put(972, FluidRegistry.getFluidStack("molten.lftrfuelbase", 1000));
        DeepDarkRecipes.put(973, FluidRegistry.getFluidStack("molten.thoriumdepletedmoltensalttsalt", 1000));
        DeepDarkRecipes.put(974, FluidRegistry.getFluidStack("molten.thoriumberylliumdepletedmoltensalttbsalt", 1000));
        DeepDarkRecipes.put(975, FluidRegistry.getFluidStack("molten.fluorinespargedtsalt", 1000));
        DeepDarkRecipes.put(976, FluidRegistry.getFluidStack("molten.fluorinespargedtbsalt", 1000));
        DeepDarkRecipes.put(977, FluidRegistry.getFluidStack("molten.fluorinateduraniumhexafluoridefuf6", 1000));

        DeepDarkRecipes.put(978, FluidRegistry.getFluidStack("zirconiumtetrafluoride", 1000));
        DeepDarkRecipes.put(979, FluidRegistry.getFluidStack("fluid.fertiliser", 1000));
        DeepDarkRecipes.put(980, FluidRegistry.getFluidStack("fluid.un32fertiliser", 1000));
        DeepDarkRecipes.put(981, FluidRegistry.getFluidStack("fluid.un18fertiliser", 1000));
        DeepDarkRecipes.put(982, FluidRegistry.getFluidStack("fluid.raisinjuice", 1000));
        DeepDarkRecipes.put(983, FluidRegistry.getFluidStack("mobessence", 1000));
        DeepDarkRecipes.put(984, FluidRegistry.getFluidStack("fluid.coalgas", 1000));
        DeepDarkRecipes.put(985, FluidRegistry.getFluidStack("fluid.ethylbenzene", 1000));
        DeepDarkRecipes.put(986, FluidRegistry.getFluidStack("fluid.anthracene", 1000));
        DeepDarkRecipes.put(987, FluidRegistry.getFluidStack("fluid.coaltar", 1000));
        DeepDarkRecipes.put(988, FluidRegistry.getFluidStack("fluid.coaltaroil", 1000));
        DeepDarkRecipes.put(989, FluidRegistry.getFluidStack("fluid.sulfuriccoaltaroil", 1000));
        DeepDarkRecipes.put(990, FluidRegistry.getFluidStack("fluid.naphthalene", 1000));
        DeepDarkRecipes.put(991, FluidRegistry.getFluidStack("fluid.kerosene", 1000));
        DeepDarkRecipes.put(992, FluidRegistry.getFluidStack("fluid.rp1fuel", 1000));
        DeepDarkRecipes.put(993, FluidRegistry.getFluidStack("fluid.nitrogentetroxide", 1000));
        DeepDarkRecipes.put(994, FluidRegistry.getFluidStack("fluid.hydrazine", 1000));
        DeepDarkRecipes.put(995, FluidRegistry.getFluidStack("fluid.monomethylhydrazine", 1000));
        DeepDarkRecipes.put(996, FluidRegistry.getFluidStack("fluid.hydratedammoniumnitrateslurry", 1000));
        DeepDarkRecipes.put(997, FluidRegistry.getFluidStack("fluid.liquidhydrogen", 1000));
        DeepDarkRecipes.put(998, FluidRegistry.getFluidStack("fluid.formaldehyde", 1000));
        DeepDarkRecipes.put(999, FluidRegistry.getFluidStack("fluid.rocketfuelmixa", 1000));
        DeepDarkRecipes.put(1000, FluidRegistry.getFluidStack("fluid.rocketfuelmixb", 1000));
        DeepDarkRecipes.put(1001, FluidRegistry.getFluidStack("fluid.rocketfuelmixc", 1000));
        DeepDarkRecipes.put(1002, FluidRegistry.getFluidStack("fluid.rocketfuelmixd", 1000));
        DeepDarkRecipes.put(1003, FluidRegistry.getFluidStack("fluid.burntlifbef2thf4uf4", 1000));
        DeepDarkRecipes.put(1004, FluidRegistry.getFluidStack("fluid.burntlifbef2zrf4uf4", 1000));
        DeepDarkRecipes.put(1005, FluidRegistry.getFluidStack("fluid.burntlifbef2zrf4u235", 1000));
        DeepDarkRecipes.put(1006, FluidRegistry.getFluidStack("fluid.impurelifbef2", 1000));
        DeepDarkRecipes.put(1007, FluidRegistry.getFluidStack("fluid.geneticmutagen", 1000));
        DeepDarkRecipes.put(1008, FluidRegistry.getFluidStack("fluid.raw.waste", 1000));
        DeepDarkRecipes.put(1009, FluidRegistry.getFluidStack("fluid.manure.slurry", 1000));
        DeepDarkRecipes.put(1010, FluidRegistry.getFluidStack("fluid.fertile.manure.slurry", 1000));
        DeepDarkRecipes.put(1011, FluidRegistry.getFluidStack("mud.red.slurry", 1000));
        DeepDarkRecipes.put(1012, FluidRegistry.getFluidStack("molten.teflon", 1000));
        DeepDarkRecipes.put(1013, FluidRegistry.getFluidStack("nitrobenzene", 1000));
        DeepDarkRecipes.put(1014, FluidRegistry.getFluidStack("aniline", 1000));
        DeepDarkRecipes.put(1015, FluidRegistry.getFluidStack("boricacid", 1000));
        DeepDarkRecipes.put(1016, FluidRegistry.getFluidStack("polyurethane", 1000));
        DeepDarkRecipes.put(1017, FluidRegistry.getFluidStack("cyclohexane", 1000));
        DeepDarkRecipes.put(1018, FluidRegistry.getFluidStack("cyclohexanone", 1000));
        DeepDarkRecipes.put(1019, FluidRegistry.getFluidStack("cadaverine", 1000));
        DeepDarkRecipes.put(1020, FluidRegistry.getFluidStack("putrescine", 1000));
        DeepDarkRecipes.put(1021, FluidRegistry.getFluidStack("fluid.2ethylanthraquinone", 1000));

        DeepDarkRecipes.put(1022, FluidRegistry.getFluidStack("fluid.2ethylanthrahydroquinone", 1000));
        DeepDarkRecipes.put(1023, FluidRegistry.getFluidStack("fluid.hydrogenperoxide", 1000));
        DeepDarkRecipes.put(1024, FluidRegistry.getFluidStack("fluid.lithiumperoxide", 1000));
        DeepDarkRecipes.put(1025, FluidRegistry.getFluidStack("carbondisulfide", 1000));
        DeepDarkRecipes.put(1026, FluidRegistry.getFluidStack("froth.zincflotation", 1000));
        DeepDarkRecipes.put(1027, FluidRegistry.getFluidStack("fluid.chalcopyritefroth", 1000));
        DeepDarkRecipes.put(1028, FluidRegistry.getFluidStack("froth.nickelflotation", 1000));
        DeepDarkRecipes.put(1029, FluidRegistry.getFluidStack("froth.platinumflotation", 1000));
        DeepDarkRecipes.put(1030, FluidRegistry.getFluidStack("froth.pentlanditeflotation", 1000));
        DeepDarkRecipes.put(1031, FluidRegistry.getFluidStack("froth.redstoneflotation", 1000));
        DeepDarkRecipes.put(1032, FluidRegistry.getFluidStack("froth.spessartineflotation", 1000));
        DeepDarkRecipes.put(1033, FluidRegistry.getFluidStack("froth.grossularflotation", 1000));
        DeepDarkRecipes.put(1034, FluidRegistry.getFluidStack("froth.almandineflotation", 1000));
        DeepDarkRecipes.put(1035, FluidRegistry.getFluidStack("froth.pyropeflotation", 1000));
        DeepDarkRecipes.put(1036, FluidRegistry.getFluidStack("froth.monaziteflotation", 1000));
        DeepDarkRecipes.put(1037, FluidRegistry.getFluidStack("pineoil", 1000));
        DeepDarkRecipes.put(1038, FluidRegistry.getFluidStack("cryotheum", 1000));
        DeepDarkRecipes.put(1039, FluidRegistry.getFluidStack("pyrotheum", 1000));
        DeepDarkRecipes.put(1040, FluidRegistry.getFluidStack("propionicacid", 1000));
        DeepDarkRecipes.put(1041, FluidRegistry.getFluidStack("fermentation.base", 1000));
        DeepDarkRecipes.put(1042, FluidRegistry.getFluidStack("ureamix", 1000));
        DeepDarkRecipes.put(1043, FluidRegistry.getFluidStack("liquidresin", 1000));
        DeepDarkRecipes.put(1044, FluidRegistry.getFluidStack("butanol", 1000));
